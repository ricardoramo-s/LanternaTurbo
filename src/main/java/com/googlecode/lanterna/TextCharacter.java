...
public class TextCharacter implements Serializable {
    ...
    public boolean equalBackgroundColors(TextCharacter other) {
        return this.backgroundColor.getBlue() == other.backgroundColor.getBlue() && this.backgroundColor.getRed() == other.backgroundColor.getRed() && this.backgroundColor.getGreen() == other.backgroundColor.getGreen();
    }
